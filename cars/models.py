...
class Car(models.Model):
    ...
    is_hidden = models.BooleanField('Скрыть для API v1', default=False, db_index=True)
    is_hidden_v2 = models.BooleanField('Скрыть для API v2', default=False, db_index=True)
